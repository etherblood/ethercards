...
public class DisplayCardTemplate extends CardTemplate {
    ...
    public DisplayCardTemplate(int templateId, boolean isMinion, Integer manaCost, TargetSelection castTarget, List<Effect> castEffects, String alias, String name, String flavourText, String description, String imagePath, List<CardColor> colors, IntMap components, Set<Tribe> tribes, List<Effect> onCastEffects, List<Effect> onSummonEffects, List<Effect> onDeathEffects, List<Effect> onSelfMovedToGraveyardEffects, List<Effect> onSurviveEffects, List<Effect> onUpkeepEffects, List<Effect> afterBattleEffects, List<Effect> onDrawEffects, Map<Integer, List<StatModifier>> componentModifiers) {
        super(templateId, isMinion, manaCost, castTarget, castEffects, components, tribes, onCastEffects, onSummonEffects, onDeathEffects, onSelfMovedToGraveyardEffects, onSurviveEffects, onUpkeepEffects, afterBattleEffects, onDrawEffects, componentModifiers);
        this.alias = alias;
        this.name = name;
