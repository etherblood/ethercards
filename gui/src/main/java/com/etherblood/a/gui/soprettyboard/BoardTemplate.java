...
public class BoardTemplate {
    ...
    public BoardTemplate(int self, Map<Integer, IntList> teamToPlayer, Vector2f teamZoneSize, Vector2f cardSize) {
        ...
        createTeamPlayerZones(teamPlayers, teamZoneSize, rotation, cardSize);
        ...
        for (IntList otherTeamPlayers : teamToPlayer.values()) {
            ...
            createTeamPlayerZones(otherTeamPlayers, teamZoneSize, rotation, cardSize);
        }
    }

    private void createTeamPlayerZones(IntList teamPlayers, Vector2f teamZoneSize, Quaternion rotation, Vector2f cardSize) {
